...
Normalmente nos meus projetos WEB eu utilizo para o frontend o $${\color{#1694ff}Ant \space design}$$ e o $${\color{#1694ff}NextJS \space + \space HeroUI}$$ e para o backend o $${\color{#53c866}EggJS}$$ e o $${\color{#cd374b}NestJS}$$.
